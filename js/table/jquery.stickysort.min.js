		...
		this.each(function() {
			if (a(this).is("table") && a(this).find("thead").length > 0 && a(this).find("th").length > 0) {
				...
				if (b.sortable || (i.data("sortable") != undefined || i.hasClass("sortable"))) {
					...
					k.addClass("sortable").find("thead th").addClass("sort-default").data("sortState", 1).append(
						'<a href="#" class="sort-handle"></a>').find(".sort-handle").click(function(o) {
						o.preventDefault()
					});
					k.on("click",
						...
						function() {
							...
							k.find("table").each(function(t) {
								a(this).find("thead th").not(":eq(" + p + ")").data("sortState", 1).removeClass().addClass(
									"sort-default")
							});
							i.find("tbody").html(o);
